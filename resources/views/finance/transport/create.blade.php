                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="transporter_id" id="transporter" class="selectize1">
                                        @foreach ($transporters as $transporter)
                                            <option value="{{ $transporter->id }}">{{ $transporter->title }} - {{ $transporter->currency }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-3 mt-2">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="fare" id="fare" oninput="calculateProfit()" value="0" class="form-control" min="0">
                                </div>
                            </div>
                            <div class="col-3 mt-2">
                                <div class="form-group">
                                    <label for="expense">Expense</label>
                                    <input type="number" name="expense" id="expense" oninput="calculateProfit()" value="0" class="form-control" min="0">
                                </div>
                            </div>
                            <div class="col-3 mt-2">
                                <div class="form-group">
                                    <label for="profit">Profit</label>
                                    <input type="number" name="profit" readonly id="profit" value="0" class="form-control" min="0">
                                </div>
                            </div>
                            <div class="col-3 mt-2">
                                <div class="form-group">
                            ...
                            <div class="col-12 mt-2">
                                <button type="submit" class="btn btn-primary w-100">Save Transport</button>
                            </div>
                        </div>
                    </form>
                </div>
