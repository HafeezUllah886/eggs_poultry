...
use App\Http\Controllers\OilReportController;
...
Route::middleware('auth', adminCheck::class)->group(function () {
    ...
    Route::get('report/engineOil', [OilReportController::class, 'index'])->name('reportEngineOil');
    Route::get('report/engineOilData', [oilReportController::class, 'data'])->name('reportEngineOilData');
});
